...
>>>>>>> 52a3d1fa68c6d261d7fbae8ec051c0fdd7f06dfe
...
W3C Markup Validator - Results:----------> https://validator.w3.org/nu/#l169c53
W3C CSS Validator - Results:-------> https://validator.w3.org/nu/#l1c81
...
The user has two options, click the HOME, WHAT WE DO or CONTACT action buttons or scroll down, both of which will lead to the same place, to learn more about the ACOUSTRA.
...
At the bottom of the page there are clear links and icons to ACOUSTRA's social media content.
...
As a First Time Visitor, I want to look for testimonials to understand what the couples who hired ACOUSTRA thought of them and see if they are a reliable good lively band. I also want to locate their social media links to see their following on social media to determine how well known they are.
...
At the bottom of the Contact Us page, the user is shown a badge to link them to a site that ACOUSTRA are a member of. This provides oppertunities for several other bands to chose from for the user should they not be able to book the band. It also provides security for how reliable ACOUSTRA are.
...
The footer contains links to the ACOUSTRA's Facebook, Twitter, Instagram and Spotify pages as well as the band's email.
...
The full-screen image was used by the band ACOUSTRA's permission. It was an image they already had that they let me use.

Bootstrap5: Bootstrap Library used in certain aspects of the project mainly to create the Contact Form.
...
All content was written by the developer and ACOUSTRA.
CodeNepal coding was used in the development of the NavBar.


Media
All Images were created by ACOUSTRA.
All logo's were created by ACOUSTRA.
...
Cormac_ci code institude tutor and Classroom Co-ordinator for his help and extremely vital support.
...
Photoshop:
The logo was created using Adobe Photoshop.
...
Neil Kavanagh_ci.... Code  Institute Tutor and Classroom Co-ordinator again for his incredible input along the journey of my project.
